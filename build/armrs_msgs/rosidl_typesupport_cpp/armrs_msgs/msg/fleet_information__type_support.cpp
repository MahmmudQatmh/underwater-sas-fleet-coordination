...
static const _FleetInformation_type_support_symbol_names_t _FleetInformation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armrs_msgs, msg, FleetInformation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, armrs_msgs, msg, FleetInformation)),
  }
};
...
{
  return &::armrs_msgs::msg::rosidl_typesupport_cpp::FleetInformation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, armrs_msgs, msg, FleetInformation)() {
  return get_message_type_support_handle<armrs_msgs::msg::FleetInformation>();
}
